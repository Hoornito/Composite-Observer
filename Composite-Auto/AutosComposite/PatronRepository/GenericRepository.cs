using Composite_Auto.GenericRepository;
using Dapper;
using System;
...
namespace Composite_Auto.PatronRepository
{
    public abstract class GenericRepository<T> : IGenericRepository<T>
    {
        ...
        private static IEnumerable GenerateListOfProperties(IEnumerable listOfProperties)
        {
